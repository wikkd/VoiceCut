...
(() => {
  ...
  function shortName(s, n = 10) { s = s || ""; return s.length > n ? s.slice(0, n) + "…" : s; }
  ...
  function setPage(name) {
    ...
    if (name === "train") loadTraining(true);
  }
  function setupPagebar() {
    ...
    const rf = $("#btn-train-refresh"); if (rf) rf.addEventListener("click", () => loadTraining(true));
    setPage(currentPage);
  }
